...
CKEDITOR.dialog.add("anchor", function (c) {
	...
	return {
			...
			this._.selectedElement
				...
				: ((b = (b = c.getSelection()) && b.getRanges()[0]),
					b.collapsed
						...
						: (CKEDITOR.env.ie && 9 > CKEDITOR.env.version && (a["class"] = "cke_anchor"), (a = new CKEDITOR.style({ element: "a", attributes: a })), (a.type = CKEDITOR.STYLE_INLINE), a.applyToRange(b)));
		},
		onHide: function () {
		...
		onShow: function () {
			...
			a = (d = a.getEnclosedNode()) && d.type === CKEDITOR.NODE_ELEMENT && ("anchor" === d.data("cke-real-element-type") || d.is("a")) ? d : void 0;
