...
public final class GqlHelper {
    ...
    public static void execute(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, String query, Map<String, ?> variables) throws IOException, ServletException, JSONException {
        ...
        BundleUtils.getOsgiService(HttpServlet.class, "(component.name=graphql.kickstart.servlet.OsgiGraphQLHttpServlet)").service(httpServletRequestWrapper, httpServletResponse);
    }
}
