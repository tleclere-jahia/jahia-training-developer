 ...
 */
public class MyOperationConstraint {

    private static final Logger logger = LoggerFactory.getLogger(MyOperationConstraint.class);
    ...
    public MyOperationConstraint(String pid, String moduleId) {
        this.pid = pid;
        this.moduleId = moduleId;
    }

    public static MyOperationConstraint parse(String pid, PropertiesValues constraintConfig) {
        // parse moduleId
        String moduleId = constraintConfig.getProperty("moduleId");
        if (moduleId == null) {
            return null;
        }
        MyOperationConstraint constraint = new MyOperationConstraint(pid, moduleId);
